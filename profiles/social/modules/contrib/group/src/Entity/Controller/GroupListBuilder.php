...
class GroupListBuilder extends EntityListBuilder {
  ...
  public function buildRow(EntityInterface $entity) {
    ...
    // User can be deleted, and content can be assigned to Anonymous making the
    // entity not have a correct label anymore.
    if (isset($entity->uid->entity)) {
      $row['uid'] = $entity->uid->entity->label();
    }
    else {
      $row['uid'] = $this->t('User does not exist or is deleted.');
    }
