...
/* profiles/social/themes/socialbase/templates/system/container.html.twig */
class __TwigTemplate_a95eecc87dc480be8c001bfb7cb04ac56cf923cd7da13a499044a94b2583fa64 extends Twig_Template
{
...
";
            ...
            if ($this->getAttribute((isset($context["attributes"]) ? $context["attributes"] : null), "hasClass", array(0 => "more-link"), "method")) {
                // line 35
                echo "    <div";
                echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute((isset($context["attributes"]) ? $context["attributes"] : null), "addClass", array(0 => "btn btn-block btn-link"), "method"), "html", null, true));
                echo ">";
                echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, (isset($context["children"]) ? $context["children"] : null), "html", null, true));
                echo "</div>
  ";
  ...
  ";
    ...
    {
        return "profiles/social/themes/socialbase/templates/system/container.html.twig";
    }
    ...
    {
        return array (  75 => 37,  67 => 35,  64 => 34,  58 => 32,  56 => 31,  53 => 30,  51 => 27,  50 => 26,  49 => 25,  48 => 24,  47 => 23,  46 => 22,  43 => 20,);
    }
}
/* {#*/
/* /***/
...
/*     <div{{ attributes.addClass('btn btn-block btn-link') }}>{{ children }}</div>*/
/*   {% else %}*/
/*     {{ children }}*/
/*   {% endif %}*/
/* {% endif %}*/
